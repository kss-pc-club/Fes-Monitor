...
function show(json:dataJsonType[]){
  const pageCount = (json.length % 6 === 0)?json.length/6:Math.ceil(json.length/6)
	...
	for(let i=0; i<pageCount+prPage; i++){
		...
		if(i===0){ b.classList.add("showing") }
